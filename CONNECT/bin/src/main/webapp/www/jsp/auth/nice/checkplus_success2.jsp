...
<%	//인증 후 결과값이 null로 나오는 부분은 관리담당자에게 문의 바랍니다.
	...
	String sSiteCode			= getConfiguration(request).getString("nicecompany.sitecode");                               // 본인실명확인 사이트코드
	String sSitePassword		= getConfiguration(request).getString("nicecompany.password");							      // 본인실명확인 비밀번호
