...
<section>
    ...
    <div class="mb-3">
        <button class="btn btn-primary" type="button" onclick="goToHouseholdModify()">글쓰기</button>
        <button class="btn btn-outline-secondary" type="button" onclick="goToHousehold()">통합</button>
    </div>
...
<script>
    ...
    const householdIdx = 'householdIdx';
    ...
    function goToHousehold() {
        location.href = '/hhd/household/household';
    }
</script>
