...
<!--                 <th>작성자</th> -->
    ...
    <script>
                ...
                success: function (map) {
                    ...
                    if (resultList.length === 0) {
                        ...
                        for (let i = 0; i < resultList.length; i++) {
                            ...
                            html += "    <button type='button' onclick=\"event.stopPropagation(); deleteRow('" + (r.householdIdx) + "')\">삭제</button>";
                            html += "  </td>";
                            html += "</tr>";
                        }
                    }
        ...
        // ✨ 행 즉시 삭제 (기존 deleteHousehold 패턴 유지: { householdIdx: id })
        function deleteRow(id) {
            if (!id) return;
            //if (!confirm('정말 삭제하시겠습니까?')) return;

            var sendData = {};
            sendData[householdIdx] = id;
