...
<script>
            ...
            success: function (map) {
                ...
                if (!resultList.length) {
                    ...
                    for (let i = 0; i < resultList.length; i++) {
                        ...
                        html += "            aria-label='항목 " + (r.mapIdx ?? '') + " 삭제'";
                        html += "            onclick=\"event.stopPropagation(); deleteRow('" + (r.mapIdx) + "')\">삭제</button>";
                        html += "  </td>";
                        html += "</tr>";
                    }
                }
    ...
    function goToMapModify(id) {
        ...
        if (id) url += '?' + mapIdx + '=' + encodeURIComponent(id);
        location.href = url;
    }
